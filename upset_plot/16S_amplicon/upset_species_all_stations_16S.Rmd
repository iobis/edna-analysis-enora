---
title: "Upset plot comparing species shared between all stations of all sites"
...
library(venn)
library(UpSetR)
setwd("D:/Boulot-Leuven/UNESCO_eDNA/venn_diagrams/species_16S")
```
...
png(filename="upset_stations_all_sites_species.png", width=25000, height=8000)
plot
dev.off()
```
