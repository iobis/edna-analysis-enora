---
title: "Venn diagrams comparing genus shared between different filters and stations for CocosIsland site"
...
library(venn)
library(UpSetR)
setwd("D:/Boulot-Leuven/UNESCO_eDNA/venn_diagrams")
```
...
```{r load_input_files}
## Load each set
set1 <- scan("Argentina/Argentina_valdes_station_1.txt", "")
set2 <- scan("Argentina/Argentina_valdes_station_2.txt", "")
set3 <- scan("Argentina/Argentina_valdes_station_3.txt", "")
set4 <- scan("Argentina/Argentina_valdes_station_4.txt", "")
set5 <- scan("Argentina/Argentina_valdes_station_5.txt", "")
set6 <- scan("Belize/Belize_bacalar_chico.txt", "")
set7 <- scan("Belize/Belize_bcmr.txt", "")
set8 <- scan("Belize/Belize_glovers_reef.txt", "")
set9 <- scan("Belize/Belize_scmr.txt", "")
set10 <- scan("Belize/Belize_swcmr.txt", "")
set11 <- scan("Brazil/Brazil_baia_dos_delfines.txt", "")
set12 <- scan("Brazil/Brazil_cagarras.txt", "")
set13 <- scan("Brazil/Brazil_sueste.txt", "")
set14 <- scan("CocosIsland/CocosIsland_dos_amigos.txt", "")
set15 <- scan("CocosIsland/CocosIsland_juan_bautista.txt", "")
set16 <- scan("CocosIsland/CocosIsland_manuelita.txt", "")
set17 <- scan("CocosIsland/CocosIsland_montagne.txt", "")
set18 <- scan("CocosIsland/CocosIsland_pni.txt", "")
set19 <- scan("CocosIsland/CocosIsland_roca.txt", "")
set20 <- scan("CocosIsland/CocosIsland_roca_sucia.txt", "")
set21 <- scan("CocosIsland/CocosIsland_sucia.txt", "")
set22 <- scan("CocosIsland/CocosIsland_taza_de_te.txt", "")
set23 <- scan("Coiba/Coiba_canales_de_afuero.txt", "")
set24 <- scan("Coiba/Coiba_granito_de_oro.txt", "")
set25 <- scan("Coiba/Coiba_isla_tortuga.txt", "")
set26 <- scan("Coiba/Coiba_oceanica.txt", "")
set27 <- scan("Coiba/Coiba_rio_san_juan.txt", "")
set28 <- scan("Coiba/Coiba_tres_islas.txt", "")
set29 <- scan("Everglades/Everglades_captain.txt", "")
set30 <- scan("Everglades/Everglades_crocodile_dragover.txt", "")
set31 <- scan("Everglades/Everglades_north_eagle_key.txt", "")
set32 <- scan("Everglades/Everglades_trout_creek.txt", "")
set33 <- scan("Everglades/Everglades_whip_ray.txt", "")
set34 <- scan("LordHowe/LordHowe_comets_hole.txt", "")
set35 <- scan("LordHowe/LordHowe_erscotts_hole.txt", "")
set36 <- scan("LordHowe/LordHowe_far_rocks.txt", "")
set37 <- scan("LordHowe/LordHowe_north_bay.txt", "")
set38 <- scan("LordHowe/LordHowe_sylphs_hole.txt", "")
set39 <- scan("Mauritania/Mauritania_pnba.txt", "")
set40 <- scan("Mexico/Mexico_isla_clarion.txt", "")
set41 <- scan("Mexico/Mexico_punta_tosca.txt", "")
set42 <- scan("Mexico/Mexico_roca_partida.txt", "")
set43 <- scan("Mexico/Mexico_san_benedicto.txt", "")
set44 <- scan("NewCaledonia/NewCaledonia_entrecasteaux.txt", "")
set45 <- scan("NewCaledonia/NewCaledonia_grand_lagoon_nord.txt", "")
set46 <- scan("NewCaledonia/NewCaledonia_kouare.txt", "")
set47 <- scan("NewCaledonia/NewCaledonia_poe_zco.txt", "")
set48 <- scan("NewCaledonia/NewCaledonia_pouebo.txt", "")
set49 <- scan("Ningaloo/Ningaloo_bundegi_beach.txt", "")
set50 <- scan("Ningaloo/Ningaloo_jurabi_coastal_park.txt", "")
set51 <- scan("Ningaloo/Ningaloo_mangrove_bay.txt", "")
set52 <- scan("Ningaloo/Ningaloo_osprey_bay.txt", "")
set53 <- scan("Ningaloo/Ningaloo_oyster_stacks.txt", "")
set54 <- scan("Philippines/Philippines_kook_south_atoll.txt", "")
set55 <- scan("Philippines/Philippines_new_bird_islet.txt", "")
set56 <- scan("Philippines/Philippines_north_east_malayan_reef.txt", "")
set57 <- scan("Philippines/Philippines_south_atoll_lagoon.txt", "")
set58 <- scan("Philippines/Philippines_south_park.txt", "")
set59 <- scan("Philippines/Philippines_twreck_south_atoll.txt", "")
set60 <- scan("Seychellen/Seychellen_bras_monsieur_claremont.txt", "")
set61 <- scan("Seychellen/Seychellen_ile_esprit.txt", "")
set62 <- scan("Seychellen/Seychellen_polymnie.txt", "")
set63 <- scan("Seychellen/Seychellen_settlement_beach.txt", "")
set64 <- scan("Seychellen/Seychellen_west_grand_terre.txt", "")
set65 <- scan("SouthAfrica/SouthAfrica_bhanga_neck.txt", "")
set66 <- scan("SouthAfrica/SouthAfrica_ingwe_beach.txt", "")
set67 <- scan("SouthAfrica/SouthAfrica_mission_rock.txt", "")
set68 <- scan("SouthAfrica/SouthAfrica_sodwana_bay.txt", "")
set69 <- scan("SouthAfrica/SouthAfrica_st_lucia_lake.txt", "")
set70 <- scan("SouthernOcean/SouthernOcean_amsterdam.txt", "")
set71 <- scan("SouthernOcean/SouthernOcean_armor.txt", "")
set72 <- scan("SouthernOcean/SouthernOcean_baie_des_swains.txt", "")
set73 <- scan("SouthernOcean/SouthernOcean_ile_haute.txt", "")
set74 <- scan("SouthernOcean/SouthernOcean_suhm.txt", "")
set75 <- scan("Yemen/Yemen_di_hamri.txt", "")
set76 <- scan("Yemen/Yemen_ditwh_pa.txt", "")
set77 <- scan("Yemen/Yemen_mahfarhin_qasharihan_mpa.txt", "")
set78 <- scan("Yemen/Yemen_qariah.txt", "")
set79 <- scan("Yemen/Yemen_roosh_mpa.txt", "")
set80 <- scan("Yemen/Yemen_shoeb_lagoon.txt", "")
set81 <- scan("Wadden/Wadden_den_oever.txt", "")
set82 <- scan("Wadden/Wadden_hjerting.txt", "")
set83 <- scan("Wadden/Wadden_neuwerk.txt", "")
set84 <- scan("Wadden/Wadden_schleswig_holstein.txt", "")
set85 <- scan("Wadden/Wadden_wilhelmshaven.txt", "")
set86 <- scan("Scandola/Scandola_elbu.txt", "")
set87 <- scan("Scandola/Scandola_ficaccia.txt", "")
set88 <- scan("Scandola/Scandola_ficaghjola.txt", "")
set89 <- scan("Scandola/Scandola_foccocara.txt", "")
set90 <- scan("Scandola/Scandola_punta_a_scopa.txt", "")
set91 <- scan("Scandola/Scandola_ruzaghiu.txt", "")
set92 <- scan("SharkBay/SharkBay_debault_creek.txt", "")
set93 <- scan("SharkBay/SharkBay_fowlers_camp.txt", "")
set94 <- scan("SharkBay/SharkBay_monkey_mia.txt", "")
set95 <- scan("SharkBay/SharkBay_petit_point.txt", "")
set96 <- scan("SharkBay/SharkBay_sandy_bay.txt", "")
set97 <- scan("Bangladesh/Bangladesh_sundarbans_1.txt", "")
set98 <- scan("Bangladesh/Bangladesh_sundarbans_2.txt", "")
set99 <- scan("Bangladesh/Bangladesh_sundarbans_3.txt", "")
set100 <- scan("Bangladesh/Bangladesh_sundarbans_4.txt", "")
set101 <- scan("Bangladesh/Bangladesh_sundarbans_5.txt", "")
set102 <- scan("Bangladesh/Bangladesh_sundarbans_6.txt", "")
...
sets.x.label = "Numbers of genus per station";
...
png(filename="upset_stations_all_sites_improved.png", width=9000, height=5000)
plot
dev.off()
```
